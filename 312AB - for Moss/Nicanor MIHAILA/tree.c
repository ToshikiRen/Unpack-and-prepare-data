...
/**
 * CERINTA 2
 * TODO: implementarea ITERATIVA functiei de parcurgere SRD(inordine)
 *  a unui arbore binar.
 * Stiva este implementata folosind un vector(vezi stack.h).
 *  In functia inorderIterative, se transmite
 * radacina arborelui si un vector in care sa stocati valorile obtinute in
 * urma parcurgerii precum si numarul
...
/**
 * CERINTA 3
 * TODO: Implementarea functiei pentru eliberarea spatiului 
 * ocupat de un arbore.
...
/**
 * CERINTA 4
 * TODO: Implementarea functiei pentru gasirea celui mai
 *  apropiat stramos comun(LCA) a doua noduri date(LCA)
 *  pentru doua noduri n1 si n2. LCA este cel mai adanc (de jos nod)
 *  care ii are pe n1 si n2 ca descendenti
